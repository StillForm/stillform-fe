    ...
    <section className="py-16">
      <Container>
        <div className="flex items-center justify-between gap-4">
          <div>
            <h2 className="font-display text-3xl text-text-primary">Featured Artists</h2>
            <p className="mt-2 max-w-lg text-text-secondary">
              Discover the creators shaping Stillform&apos;s physical-digital futures. Follow to get early
              access to drops and blind capsules.
            </p>
          </div>
          ...
          <div className="flex min-w-full gap-6">
            {featuredArtists.map((artist) => (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {artist.verified ? <Badge variant="gold">Verified</Badge> : null}
                    </div>
                ...
                <p className="mt-5 text-sm text-text-secondary">{artist.description}</p>
