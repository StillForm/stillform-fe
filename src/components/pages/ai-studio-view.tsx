...
export function AiStudioView() {
  ...
  const [prompt, setPrompt] = useState(
    searchParams.get("from")
      ? `Inspired by ${searchParams.get("from")}`
      : "Hyper-real crystal installation"
  );
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <h1 className="mt-3 font-display text-4xl text-text-primary">
            Generate lighting boards
          </h1>
          <p className="mt-2 max-w-2xl text-text-secondary">
            Tailor prompting to Kaiwu&apos;s dark purple gold aesthetic.
            Selected variants can sync back into your Creator Studio drafts as
            references.
          </p>
        </div>
